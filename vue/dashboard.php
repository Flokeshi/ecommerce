...
<html lang="fr">
	<head>
		<meta charset="utf-8">
		<title>Board Games dashboard</title>
		...
		<div class='dashboard'>
			<div class="dashboard-nav">
				...
				<nav class="dashboard-nav-list">
					...
					<a href="../vue/dashboard.php" class="dashboard-nav-item active"><i class="fas fa-tachometer-alt"></i> Dashboard </a>
					...
					<div class='container'>
						<div class='card'>
							<div class='card-header'>
								<h1 style="color:black;">Welcome back <?php echo $userName['user_firstname']." ".$userName['user_lastname']; ?></h1>
							</div>
							<div class='card-body'>
